...
public class Greeter extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		LocalTime start = (LocalTime) session.getAttribute("start"); // il downcast è pericoloso ma si usa fare qui cosi
																		// senza instance of

		Duration duration;
		if (start == null) {
			duration = Duration.ZERO; // ZERO è la costante, una variabile final della classe duration
